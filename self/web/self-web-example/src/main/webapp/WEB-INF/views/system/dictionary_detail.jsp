...
<!-- 基本信息 -->
<form id="dictionaryDetailFrom"  method="post">
	...
	<div style="padding:5px 0 5px 60px">
    	<table>
    		...
    		<tr>
    			...
    			<td><input class="easyui-validatebox" type="text"  name="codeSort" data-options="required:true"></input></td>
    		</tr>
    		<tr>
    			...
    			<td><input class="easyui-validatebox" type="text"  name="isOperate" id="isOperate" data-options="required:true"></input></td>
    		</tr>
    		<tr>
...
<script type="text/javascript" src="js/modules/system/dictionary_detail.js"></script>
