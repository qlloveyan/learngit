...
<head>
	...
	<script type="text/javascript" src="js/modules/system/funcModule.js"></script>
   	
</head>
<body class="easyui-layout" fit="true">

<!-- 	<div region="west" border="false"  title="资源管理" class="cs-west" style="width: 270px;"> -->
<!-- 		<ul id="funcModuleTree" class="easyui-tree" ></ul> -->
<!-- 	</div> -->
	<div region="west" class="listLeft-max">
    	<h1 class="tree-h1"><b class="list-tree-ico"></b>资源管理</h1>
		<ul id="funcModuleTree" class="easyui-tree jstree" ></ul>
	</div>
		...
		<div class="easyui-layout" fit="true">
			<div region="north">
				<div class="search-left" >
					...
					<form id="funcModuleFrom" method="post" >
			...
			<div region="center">
				<table id="funcModuleGrid"></table>
			</div>
		</div>
	</div>
	
	<div id="mm" class="easyui-menu" >  
    	<div iconCls="icon-add" onclick="addFuncModule()"><i class="add"></i>新增资源</div>  
