...
<head>
	...
	<script type="text/javascript" src="js/modules/system/element.js"></script>
...
<!-- 	</div> -->
				...
				<div class="search-left" >
					...
					<form id="elementFrom" method="post" >
						...
						<div class="search-form">
							<table>
					    		<tr>
									<td style="width: 300px;text-align: right;"><span><label class="label4">菜单名称:</label><input class="input-small" name="funcName" /></span></td>
									<td style="width: 300px;text-align: right;"><span><label class="label4">菜单编码: </label><input class="input-small" name="funcCode"/></span></td>
									<td style="width: 300px;text-align: right;"><span><label class="label4">菜单URL: </label><input class="input-small" name="url" style="width: 150px;"/></span></td>
								</tr>
								<tr>
	...
	<div id="mm" class="easyui-menu" >  
    	<div iconCls="icon-add" onclick="addElement()"><i class="add"></i>新增页面元素</div>  
