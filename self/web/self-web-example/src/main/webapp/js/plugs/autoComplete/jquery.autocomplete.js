...
(function($){
    ...
    var _select = function(){
        ...
        if (selected.size()) {
            ...
            //wangguohong  修改显示值为label
           // this.inputView.val(data.label);
            this.inputView.val(data.showvalue);
            
            //设置搜索框的url
            this.inputView.attr("url",data.url);
            //设置搜索框的frameName
            this.inputView.attr("frameName",data.frameName);
