...
function loadData(){
	...
	$('#elementGrid').datagrid({
		...
		idField:'id',
		columns:[[
			{field:'elementCode',title:'页面元素编码',width:80,align:'center',sortable:true},
			{field:'elementName',title:'元素名称',width:80,align:'center',sortable:true},
			{field:'funcName',title:'所属菜单',width:80,align:'center',sortable:true},
...
function editElement(id){
	...
	openWin("editElementWin","system/redirect/redirectHomePage.do?path=system/element_edit","编辑页面元素信息",350,200,params);
}
