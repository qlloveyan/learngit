 ...
 * File Name:DepartmentMapper.java<br>
...
/**
 * ClassName:DepartmentMapper.java<br>
...
public interface DepartmentMapper {
   ...
   /**
	 ...
	 * @since JDK 1.6
	 */
    public int editEntity(Department department);
   ...
   /**
	 ...
	 * @since JDK 1.6
	 */
	public List<Department> list(Department department,RowBounds rowBounds);
