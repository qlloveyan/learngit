...
public interface StaffMapper {
	 ...
	 * @since JDK 1.6
	 */
	public void addEntity(Staff staff);
   ...
   /**
	 ...
	 * @since JDK 1.6
	 */
    public int editEntity(Staff staff);
   ...
   /**
	 ...
	 * @since JDK 1.6
	 */
	public List<Staff> list(Staff staff,RowBounds rowBounds);
