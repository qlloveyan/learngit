 ...
 * File Name:ProgramMapper.java<br>
...
/**
 * ClassName:ProgramMapper.java<br>
...
public interface ProgramMapper {
	 ...
	 * @since JDK 1.6
	 */
	public void addEntity(Program program);
   ...
   /**
	 ...
	 * @since JDK 1.6
	 */
    public int editEntity(Program program);
   ...
   /**
	 ...
	 * @since JDK 1.6
	 */
	public long count(Program program);
   ...
   /**
	 ...
	 * @since JDK 1.6
	 */
	public List<Program> list(Program program,RowBounds rowBounds);
