 ...
 * File Name:ReviewMapper.java<br>
...
/**
 * ClassName:ReviewMapper.java<br>
...
public interface ReviewMapper {
   ...
   /**
	 ...
	 * @since JDK 1.6
	 */
    public int editEntity(Review review);
   ...
   /**
	 ...
	 * @since JDK 1.6
	 */
	public long count(Review review);
   ...
   /**
	 ...
	 * @since JDK 1.6
	 */
	public List<Review> list(Review review,RowBounds rowBounds);
